...
<form action="viewselffattendance.php" method ="post" style="border:1px solid #ccc">
  <div class="container">
...
<select name="fyear">
    ...
    <div class="clearfix">
      <a href="viewselffattendance.php" ><button type="button" class="Refreshbtn">Refresh</button></a>
...
$Selsect = "SELECT fname FROM faculty WHERE id=".$fid;
