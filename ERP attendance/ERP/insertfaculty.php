...
<form action="insertfaculty.php" method="post" style="border:1px solid #ccc">
  <div class="container">
  <label><b>Faculty id</b></label>
    ...
    <input type="text" placeholder="Username" name="hfusername" required>
    <label><b>Password</b></label>
    <input type="text" placeholder="Password" name="hfpassword" required>
    <div class="clearfix">
    <div class="clearfix">
      <a href="insertfaculty.php"><button type="button" class="Refreshbtn">Refresh</button></a>
...
$Fusername = $_POST["hfusername"];
$Fpassword=$_POST["hfpassword"];

$sql = "Insert into faculty (fid,fname,fgender,femail,fusername,fpassword) values ('$Fid','$Fname','$Fgender','$Femail','$Fusername','$Fpassword')";
